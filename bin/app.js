...
(function(exports) {
  ...
  var Location = (function () {
      function Location(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      Location.create = function (value0) {
          return function (value1) {
              return new Location(value0, value1);
          };
      };
      return Location;
  })();
  ...
  var Batsu = (function () {
      ...
      Batsu.value = new Batsu();
      return Batsu;
  })();
  var MaruTurn = (function () {
      function MaruTurn() {

      };
      MaruTurn.value = new MaruTurn();
      return MaruTurn;
  })();
  var BatsuTurn = (function () {
      function BatsuTurn() {

      };
      BatsuTurn.value = new BatsuTurn();
      return BatsuTurn;
  })();
  var MaruWin = (function () {
      function MaruWin() {

      };
      MaruWin.value = new MaruWin();
      return MaruWin;
  })();
  var BatsuWin = (function () {
      function BatsuWin() {

      };
      BatsuWin.value = new BatsuWin();
      return BatsuWin;
  })();
  var Drow = (function () {
      function Drow() {
  ...
  var NotGame = (function () {
      function NotGame() {

      };
      NotGame.value = new NotGame();
      return NotGame;
  })();
  var NotPut = (function () {
      function NotPut() {
      ...
      NotPut.value = new NotPut();
      return NotPut;
  })();
  var Ban = function (x) {
      return x;
  };
  var turnChange = function (v) {
      if (v instanceof MaruTurn) {
          return BatsuTurn.value;
      };
      if (v instanceof BatsuTurn) {
          return MaruTurn.value;
      };
      return v;
  };
  var rotate = function (l) {
      return Data_List.reverse(Data_List.transpose(l));
  };
  var putRight = function (v) {
      return function (v1) {
          return function (v2) {
              if (v1 === 0 && (v2 instanceof Data_List_Types.Cons && v2.value0 instanceof Brank)) {
                  return Data_Maybe.Just.create(new Data_List_Types.Cons(v, v2.value1));
              };
              if (v1 === 0) {
                  return Data_Maybe.Nothing.value;
              };
              if (v2 instanceof Data_List_Types.Cons) {
                  return Control_Bind.bind(Data_Maybe.bindMaybe)(putRight(v)(v1 - 1 | 0)(v2.value1))(function (v3) {
                      return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(new Data_List_Types.Cons(v2.value0, v3));
                  });
              };
              return Data_Maybe.Nothing.value;
          };
  ...
  var putDoun = function (v) {
      return function (v1) {
          return function (v2) {
              return function (v3) {
                  if (v2 === 0 && v3 instanceof Data_List_Types.Cons) {
                      return Control_Bind.bind(Data_Maybe.bindMaybe)(putRight(v)(v1)(v3.value0))(function (v4) {
                          return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(new Data_List_Types.Cons(v4, v3.value1));
                      });
                  };
                  if (v2 === 0) {
                      return Data_Maybe.Nothing.value;
                  ...
                  if (v3 instanceof Data_List_Types.Cons) {
                      return Control_Bind.bind(Data_Maybe.bindMaybe)(putDoun(v)(v1)(v2 - 1 | 0)(v3.value1))(function (v4) {
                          return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(new Data_List_Types.Cons(v3.value0, v4));
                      });
                  };
                  return Data_Maybe.Nothing.value;
              };
  ...
  var put = function (koma) {
      return function (x) {
          return function (y) {
              return function (v) {
                  return Data_Functor.map(Data_Maybe.functorMaybe)(Ban)(putDoun(koma)(x)(y)(v));
              };
          };
      };
  };
  var mkRightList = function (l) {
      return Data_Traversable.sequence(Data_List_Types.traversableList)(Data_Maybe.applicativeMaybe)(Data_Functor.map(Data_List_Types.functorList)(Data_List.tail)(l));
  };
  var mkDouwnRightList = function (v) {
      if (v instanceof Data_List_Types.Cons) {
          return mkRightList(v.value1);
      };
      return Data_Maybe.Nothing.value;
  };
  var mkBan = function (n) {
      return Ban(Data_Unfoldable.replicate(Data_List_Types.unfoldableList)(n)(Data_Unfoldable.replicate(Data_List_Types.unfoldableList)(n)(Brank.value)));
  };
  var mkState = function (n) {
      return function (nn) {
          return {
              state: MaruTurn.value,
              ban: mkBan(n),
              count: nn
          };
      };
  };
  var getWin = function (v) {
      if (v instanceof Maru) {
          return MaruWin.value;
      };
      if (v instanceof Batsu) {
          return BatsuWin.value;
      };
      return Drow.value;
  };
  ...
  var getList = function (func) {
      return function (v) {
          return Data_List.mapWithIndex(function ($121) {
              return Data_List.mapWithIndex((function (fn) {
                  return function (y) {
                      return function (x) {
                          return fn(new Location(x, y));
                      };
                  };
              })(func)($121));
          })(v.ban);
  ...
  var getKoma = function (v) {
      if (v instanceof MaruTurn) {
          return new Data_Maybe.Just(Maru.value);
      };
      if (v instanceof BatsuTurn) {
          return new Data_Maybe.Just(Batsu.value);
      };
      return Data_Maybe.Nothing.value;
  };
  var eqKoma = new Data_Eq.Eq(function (x) {
      return function (y) {
          if (x instanceof Brank && y instanceof Brank) {
              return true;
          };
          if (x instanceof Maru && y instanceof Maru) {
              return true;
          };
          if (x instanceof Batsu && y instanceof Batsu) {
              return true;
          };
          return false;
      };
  });
  var checkRight = function ($copy_v) {
      return function ($copy_v1) {
          return function ($copy_v2) {
              var $tco_var_v = $copy_v;
              var $tco_var_v1 = $copy_v1;
              ...
              function $tco_loop(v, v1, v2) {
                  ...
                  if (v2 instanceof Data_List_Types.Cons && v(v2.value0)) {
                      $tco_var_v = v;
                      $tco_var_v1 = v1 - 1 | 0;
                      $copy_v2 = v2.value1;
                      return;
  ...
  var checkDownRight = function (v) {
      return function (v1) {
          return function (v2) {
              if (v1 === 0) {
                  return true;
              };
              if (v2 instanceof Data_List_Types.Cons && (v2.value0 instanceof Data_List_Types.Cons && v(v2.value0.value0))) {
                  return Data_Maybe.maybe(false)(checkDownRight(v)(v1 - 1 | 0))(mkDouwnRightList(v2));
              };
              return false;
          };
      };
  };
  var checkDown = function ($copy_v) {
      return function ($copy_v1) {
          return function ($copy_v2) {
              var $tco_var_v = $copy_v;
              var $tco_var_v1 = $copy_v1;
  ...
  var checkDownAll = function (v) {
      return function (v1) {
          return function (v2) {
              if (v2 instanceof Data_List_Types.Cons && (v2.value0 instanceof Data_List_Types.Cons && v(v2.value0.value0))) {
                  return checkDown(v)(v1)(v2) || (checkDownRight(v)(v1)(v2) || (checkRight(v)(v1)(v2.value0) || checkDownAll(v)(v1)(v2.value1)));
              };
              if (v2 instanceof Data_List_Types.Cons && v2.value0 instanceof Data_List_Types.Cons) {
                  return checkDownAll(v)(v1)(v2.value1);
              };
              return false;
          };
      };
  };
  var checkAll = function (koma) {
      return function (count) {
          return function (l) {
              return checkDownAll(koma)(count)(l) || Data_Maybe.maybe(false)(checkAll(koma)(count))(mkRightList(l));
          };
      };
  };
  var checkWin = function (count) {
      return function (koma) {
          return function (v) {
              return checkAll(function (v1) {
                  return Data_Eq.eq(eqKoma)(v1)(koma);
              })(count)(v) || checkAll(function (v1) {
                  return Data_Eq.eq(eqKoma)(v1)(koma);
              })(count)(rotate(v));
          };
      };
  };
  var checkWinMaybe = function (count) {
      return function (koma) {
          return function (v) {
              return checkAll(function (k) {
                  return Data_Eq.eq(eqKoma)(k)(koma) || Data_Eq.eq(eqKoma)(k)(Brank.value);
              })(count)(v) || checkAll(function (k) {
                  return Data_Eq.eq(eqKoma)(k)(koma) || Data_Eq.eq(eqKoma)(k)(Brank.value);
              })(count)(rotate(v));
          };
      };
  ...
  var update = function (v) {
      return function (v1) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Either.note(NotGame.value)(getKoma(v1.state)))(function (v2) {
              return Control_Bind.bind(Data_Either.bindEither)(Data_Either.note(NotPut.value)(put(v2)(v.value0)(v.value1)(v1.ban)))(function (v3) {
                  var isWin = checkWin(v1.count)(v2)(v3);
                  return Control_Applicative.pure(Data_Either.applicativeEither)((function () {
                      ...
                      var $115 = checkWinMaybe(v1.count)(Maru.value)(v3) || checkWinMaybe(v1.count)(Batsu.value)(v3);
                      if ($115) {
                          return {
                              state: turnChange(v1.state),
                              ban: v3,
                              count: v1.count
                          };
                      };
  ...
  exports["Maru"] = Maru;
  exports["Batsu"] = Batsu;
  exports["MaruTurn"] = MaruTurn;
  exports["BatsuTurn"] = BatsuTurn;
  exports["MaruWin"] = MaruWin;
  exports["BatsuWin"] = BatsuWin;
  exports["Drow"] = Drow;
  exports["NotGame"] = NotGame;
  exports["NotPut"] = NotPut;
  exports["update"] = update;
  exports["mkState"] = mkState;
  exports["getList"] = getList;
  exports["getState"] = getState;
  exports["eqKoma"] = eqKoma;
})(PS["Logic.Game"] = PS["Logic.Game"] || {});
(function(exports) {
  // Generated by purs version 0.12.3
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  ...
  var Halogen_HTML_Properties = PS["Halogen.HTML.Properties"];
  var Halogen_Query_HalogenM = PS["Halogen.Query.HalogenM"];
  var Logic_Game = PS["Logic.Game"];
  var Prelude = PS["Prelude"];                 
  var Tap = (function () {
      function Tap(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      Tap.create = function (value0) {
          return function (value1) {
              return new Tap(value0, value1);
          };
      };
      return Tap;
  })();
  ...
  var ChangeBan = (function () {
      function ChangeBan(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ChangeBan.create = function (value0) {
          return function (value1) {
              return new ChangeBan(value0, value1);
          };
      };
      return ChangeBan;
  })();
  var toStateString = function (v) {
      if (v instanceof Logic_Game.MaruTurn) {
          return "\u3007\u306e\u30bf\u30fc\u30f3\u3067\u3059";
      };
      if (v instanceof Logic_Game.BatsuTurn) {
          return "\xd7\u306e\u30bf\u30fc\u30f3\u3067\u3059";
      };
      if (v instanceof Logic_Game.MaruWin) {
          return "\u3007\u306e\u52dd\u3061\u3067\u3059";
      };
      if (v instanceof Logic_Game.BatsuWin) {
          return "\xd7\u306e\u52dd\u3061\u3067\u3059";
      };
      if (v instanceof Logic_Game.Drow) {
          return "\u5f15\u304d\u5206\u3051\u3067\u3059";
      };
      throw new Error("Failed pattern match at View.Game (line 27, column 1 - line 27, column 37): " + [ v.constructor.name ]);
  };
  var ticTacTorState = Logic_Game.mkState(3)(3);
  var ticTacTor = "\u4e09\u76ee\u4e26\u3079";
  var renderBan = function ($29) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.attr("style")("\x0a          width: 300px;\x0a          margin: auto;\x0a        ") ])(Data_Functor.map(Data_Functor.functorArray)(function (l) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.attr("uk-grig")(""), Halogen_HTML_Properties.classes([ "uk-grid-collapse", "uk-grid", "uk-child-width-expand" ]), Halogen_HTML_Properties.attr("style")("\x0a        ") ])(Data_Functor.map(Data_Functor.functorArray)(function (v) {
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "cell-line" ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Tap.create(v.value0))), Halogen_HTML_Properties.classes([ "uk-card", "uk-card-default", "uk-text-center" ]), Halogen_HTML_Properties.attr("style")("\x0a          position: absolute;\x0a          top: 0;\x0a          width: 100%;\x0a          height: 100%;\x0a        ") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.attr("style")("\x0a                position: absolute;\x0a                top: 50%;\x0a                left: 50%;\x0a                transform: translateY(-50%) translateX(-50%);\x0a                -webkit- transform: translateY(-50%) translateX(-50%);\x0a                font-size: 18px;\x0a        ") ])([ Halogen_HTML_Core.text((function () {
                  var $8 = Data_Eq.eq(Logic_Game.eqKoma)(v.value1)(Logic_Game.Maru.value);
                  if ($8) {
                      return "\u3007";
                  };
                  var $9 = Data_Eq.eq(Logic_Game.eqKoma)(v.value1)(Logic_Game.Batsu.value);
                  if ($9) {
                      return "\xd7";
                  };
                  return "";
  ...
  var gomokuState = Logic_Game.mkState(15)(5);
  var gomoku = "\u4e94\u76ee\u4e26\u3079";
  var render = function (state) {
      var turn = Logic_Game.getState(state.g);
      var ban = Data_List.toUnfoldable(Data_Unfoldable.unfoldableArray)(Data_Functor.map(Data_List_Types.functorList)(Data_List.toUnfoldable(Data_Unfoldable.unfoldableArray))(Logic_Game.getList(function (l) {
          return function (k) {
              return new Data_Tuple.Tuple(l, k);
          };
      })(state.g)));
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "uk-text-center" ]) ])([ Halogen_HTML_Core.text(toStateString(turn)) ]), renderBan(ban), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.attr("style")("\x0a            width: 300px;\x0a            margin: auto;\x0a          ") ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.classes([ "uk-button", "uk-button-default" ]), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Reset.create)) ])([ Halogen_HTML_Core.text("Reset") ]), Halogen_HTML_Elements.select([ Halogen_HTML_Properties.classes([ "uk-select" ]), Halogen_HTML_Events.onValueChange(Halogen_HTML_Events.input(ChangeBan.create)) ])([ Halogen_HTML_Elements.option_([ Halogen_HTML_Core.text(ticTacTor) ]), Halogen_HTML_Elements.option_([ Halogen_HTML_Core.text(gomoku) ]) ]) ]) ]);
  };
  var $$eval = function (v) {
      if (v instanceof Tap) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
              var nextState = Logic_Game.update(v.value0)(v1.g);
      ...
      if (v instanceof ChangeBan) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
              var $25 = v.value0 === ticTacTor;
              if ($25) {
                  return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)({
                      g: ticTacTorState,
                      ticOrGo: ticTacTor
      ...
      throw new Error("Failed pattern match at View.Game (line 153, column 8 - line 178, column 10): " + [ v.constructor.name ]);
  };
  var comp = Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
  ...
  exports["Tap"] = Tap;
  exports["Reset"] = Reset;
  exports["ChangeBan"] = ChangeBan;
  exports["toStateString"] = toStateString;
  exports["ticTacTor"] = ticTacTor;
  exports["gomoku"] = gomoku;
  exports["comp"] = comp;
  exports["render"] = render;
  exports["renderBan"] = renderBan;
  exports["ticTacTorState"] = ticTacTorState;
  exports["gomokuState"] = gomokuState;
  exports["initialState"] = initialState;
})(PS["View.Game"] = PS["View.Game"] || {});
(function(exports) {
  // Generated by purs version 0.12.3
  "use strict";
  var Control_Bind = PS["Control.Bind"];
